...
public class EarthquakeCityMap extends PApplet {
	...
	public void mouseClicked()
	{
		...
		{
			changecityVis(quakeMarkers);
		}
		}
	}
	private void changecityVis(List<Marker> markers)
	{
		Location l=lastClicked.getLocation();
		for(Marker mk:markers)
		{
			if(mk.getDistanceTo(l)<=(((EarthquakeMarker)mk).threatCircle()))
			{
				mk.setHidden(false);
			}
			else
	...
	private void changevisibilty(List<Marker> markers)
	{
		double radius=((EarthquakeMarker)lastClicked).threatCircle();
		Location l=lastClicked.getLocation();
		for(Marker mk:markers)
		{
			if(mk.getDistanceTo(l)<=radius)
			{
				mk.setHidden(false);
			}
			else
	...
	private void selectMarkerIfClicked(List<Marker> markers)
	{
		...
		for(Marker mk:markers)
		{
			...
			if(!mk.isHidden()&&mk.isInside(map, mouseX, mouseY)&&lastClicked==null)
			{
